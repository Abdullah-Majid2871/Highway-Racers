...
public class Menu  {
    ...
    private static Rectangle quitButton = new Rectangle(buttonX, (int)(GamePanel.GAME_HEIGHT/3 + GamePanel.GAME_HEIGHT/4), buttonWidth, 90);
    ...
    public void render(Graphics g) {
        ...
        // draws header
        g.drawString("WELCOME TO HIGHWAY RACERS", (int)(GamePanel.GAME_WIDTH/25), (int)(GamePanel.GAME_HEIGHT/7.8125));
